...
export const I18N = {
  ko: {
    ...
    hero: {
      eyebrow: '귀여운 AI 고양이가 함께해요',
      h1Top: '꿈을 이루는',
      h1Highlight: 'AI 고양이',
      sub: '큰 꿈을 오늘 할 수 있는 한 걸음으로.\n매일 옆에서 응원하는 친구가 함께 자라요.',
  ...
  en: {
    ...
    hero: {
      eyebrow: 'Your AI cat companion',
      h1Top: 'Achieve dreams with',
      h1Highlight: 'an AI cat',
      sub: 'Turn big dreams into one doable step for today.\nA friendly companion that grows with you.',
      ctaPrimary: 'Get it on App Store',
  ...
  'zh-TW': {
    ...
    hero: {
      eyebrow: '可愛的 AI 貓陪你一起',
      h1Top: '陪你實現夢想的',
      h1Highlight: 'AI 貓',
      sub: '把大夢想拆成今天能做的一小步。\n每天陪伴的小夥伴跟你一起成長。',
      ctaPrimary: 'App Store 下載',
      ctaSecondary: '查看功能',
      trust1: '支援 9 種語言',
      trust2: 'AI 教練',
      trust3: '3 天免費體驗',
